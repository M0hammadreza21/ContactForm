...
session_start();
	...
	*/
	...
	$number = substr(rand(12345, 99999), 0, 6);
	...
	$img = imagecreate(109, 25);
	imagecolorallocate($img, 219, 219, 219);
	...
	// Setting image
	imagefttext($img, 21, rand(2, 5), rand(1, 9), rand(25, 35), $text_color, $font, $text);
